...
nhelp() {
    ...
    _nh_row "zR / zM"          "open / close ALL folds (native vim)"
    ...
    _nh_row "gl"                "document symbols — fuzzy search current file (aerial)"
    _nh_row "<space>lo"        "toggle outline sidebar  (aerial)"
